...
<div className="location-wrapper">
  {loading?<p className = "location-status">we are tracking your location</p>:<p className = "location-status">Your location will tracked and will be sent to our emergency team</p>}
