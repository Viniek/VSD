  ...
  const helpArray = [
    {
      ...
      heading: "VSD Testing ",
      helpDescription:
        "To test your VSD status,navigate to home page.You will see a form which you are required to fill with details.click On run test and you will see your VSD result appear on the right side of the page",
    ...
    },
    {
      ...
      helpDescription:
        "Navvigate to emergencies section.Submit your name and your emergency description.Click on Submit button which will send your emergency and your location to our team . ",
      helpButtons: { view: "view", message: "message" },
    },
    {
      id: 3,
          ...
          helpArray.map((help) => (
            <div key={help.id} className="help-wrapper" id="help-wrapper">
              ...
              <div className="helpActions">
                <button className="view-help-btn">
                  {help.helpButtons.view}
                </button>
                <button className="message-button">
                  {help.helpButtons.message}
                </button>
              </div>
