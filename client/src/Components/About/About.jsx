    ...
    <div className="about-section-wrapper">
      <div className="about-hero">
        ...
        <div className="about-description">
          ...
          <p>
            ...
            vero asperiores tenetur voluptas molestiae quae laborum nemo commodi
            neque.
          </p>
          <p>
      ...
      <section className="about-offers">
        <div className="offers-container">
          ...
          <h2>Treatment</h2>
          <p>
            Provides suggested treatments based on condition severity levels.
          </p>
        </div>
        ...
        <div className="offers-container">
          ...
          <p>
            {" "}
            Connects to emergency services for immediate medical assistance.
          </p>
        </div>
        ...
        <div className="offers-container">
          ...
          <h2>Notifications</h2>
          <p>
            Users receive real-time notifications for bookings and account
            updates.
          </p>
        </div>
        ...
        <div className="offers-container">
          ...
          <p> Built with React.js and Flask for seamless user experience.</p>
        </div>
      </section>
        ...
        <form onSubmit={formik.handleSubmit}>
          ...
          <div className="contact-form-inputs">
            ...
            {formik.touched.contactMessage && formik.errors.contactMessage && (
              <p className="errors">{formik.errors.contactMessage}</p>
            )}
          </div>
